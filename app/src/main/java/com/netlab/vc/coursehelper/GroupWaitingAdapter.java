...
public class GroupWaitingAdapter extends BaseAdapter implements ListAdapter {
    private LayoutInflater viewInflater;
    private final Context context;
    private final int layout;
    private Member[] memberList;

    public GroupWaitingAdapter(Context context, int layout, Member[] memberList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView memberNameView=(TextView)view.findViewById(R.id.waiting_member_name);
